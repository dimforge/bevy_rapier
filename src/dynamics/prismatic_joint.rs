...
impl PrismaticJoint {
    ...
    pub fn new(axis: impl AsPrecise<Out = Vect>) -> Self {
        let data = GenericJointBuilder::new(JointAxesMask::LOCKED_PRISMATIC_AXES)
            .local_axis1(axis.as_precise())
            .local_axis2(axis.as_precise())
            .build();
        Self { data }
    }
...
impl PrismaticJointBuilder {
    ...
    /// This axis is expressed in the local-space of both rigid-bodies.
    pub fn new(axis: impl AsPrecise<Out = Vect>) -> Self {
        Self(PrismaticJoint::new(axis.as_precise()))
    }
    ...
    /// Sets the principal axis of the joint, expressed in the local-space of the first rigid-body.
    #[must_use]
    pub fn local_axis1(mut self, axis1: impl AsPrecise<Out = Vect>) -> Self {
        self.0.set_local_axis1(axis1.as_precise());
        self
    }

    /// Sets the principal axis of the joint, expressed in the local-space of the second rigid-body.
    #[must_use]
    pub fn local_axis2(mut self, axis2: impl AsPrecise<Out = Vect>) -> Self {
        self.0.set_local_axis2(axis2.as_precise());
        self
    }
